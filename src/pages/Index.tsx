  ...
  return (
    <div className="min-h-screen bg-neutral-100">
      ...
      <header className="container-padding py-6">
        <nav className="flex items-center justify-between glass-panel rounded-full px-6 py-4 mb-24">
          ...
          <div className="flex gap-4">
            <button className="px-4 py-2 text-primary hover:text-primary/80 transition-colors">Log in</button>
            <button className="button-secondary">Try for Free</button>
          </div>
        </nav>
